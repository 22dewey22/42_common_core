...
/*   Updated: 2024/05/28 12:48:16 by dwayenbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		print_error_msg_exit(char *err_msg);
...
int			line_is_walid_par_open(t_split **first, int *open_par,
				t_mini *mini);
...
int			signal_ms(void);
/*syntax_errors.c*/
int			syntax_err_msg(int err_value, char *current_token,
				char *next_token);
/*tokenizer.c*/
...
/*dollar_expand.c*/
int			dollar_expander(t_split **line_list, t_mini *mini);
