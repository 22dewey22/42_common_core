...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/14 07:48:06 by dwayenbo          #+#    #+#             */
/*   Updated: 2023/10/31 11:06:51 by dwayenbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list				*ft_lstmap(t_list *lst, void *(*f)(void *),
						void (*del)(void *));
// ADD-ONS
int					ft_is_charset(char c, char *s);
void				ft_print_hex_fd(unsigned long long value, int upcase,
						int append, int fd);
